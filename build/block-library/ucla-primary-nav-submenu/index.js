...
/***/ "./src/block-library/ucla-primary-nav-submenu/edit.js":
/*!************************************************************!*\
  !*** ./src/block-library/ucla-primary-nav-submenu/edit.js ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/remove-submenu.js");
...
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./icons */ "./src/block-library/ucla-primary-nav-submenu/icons.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./block.json */ "./src/block-library/ucla-primary-nav-submenu/block.json");
...
const ALLOWED_BLOCKS = ['ucla-wcl-wpblocks/ucla-primary-nav-link', 'ucla-wcl-wpblocks/ucla-primary-nav-submenu'];
const DEFAULT_BLOCK = {
...
const updateNavigationLinkBlockAttributes = function () {
  ...
  const label = escapeTitle ? escape_html__WEBPACK_IMPORTED_MODULE_2___default()(title) : originalLabel || escape_html__WEBPACK_IMPORTED_MODULE_2___default()(normalizedURL);
  ...
  setAttributes({
    ...
    ...(url && {
      url: encodeURI((0,_wordpress_url__WEBPACK_IMPORTED_MODULE_8__.safeDecodeURI)(url))
    }),
    ...(label && {
      label
    }),
...
function NavigationSubmenuEdit(_ref) {
  ...
  const {
    saveEntityRecord
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useDispatch)(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_10__.store);
  const {
  ...
  const itemLabelPlaceholder = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Add text…');
  const ref = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  const pagesPermissions = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_10__.useResourcePermissions)('pages');
  const postsPermissions = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_10__.useResourcePermissions)('posts');
  const {
    isAtMaxNesting,
    isTopLevelItem,
    ...
    if ((selectedBlockChildren === null || selectedBlockChildren === void 0 ? void 0 : selectedBlockChildren.length) === 1) {
      ...
      _onlyDescendantIsEmptyLink = (singleBlock === null || singleBlock === void 0 ? void 0 : singleBlock.name) === 'ucla-wcl-wpblocks/ucla-primary-nav-link' && !(singleBlock !== null && singleBlock !== void 0 && (_singleBlock$attribut = singleBlock.attributes) !== null && _singleBlock$attribut !== void 0 && _singleBlock$attribut.label);
    }
    return {
      isAtMaxNesting: getBlockParentsByBlockName(clientId, _block_json__WEBPACK_IMPORTED_MODULE_15__.name).length >= maxNestingLevel,
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (isLinkOpen && url) {
      ...
      if ((0,_wordpress_url__WEBPACK_IMPORTED_MODULE_8__.isURL)((0,_wordpress_url__WEBPACK_IMPORTED_MODULE_8__.prependHTTP)(label)) && /^.+\.[a-z]+/.test(label)) {
        // Focus and select the label text.
        selectLabelText();
      } else {
        // Focus it (but do not select).
        (0,_wordpress_dom__WEBPACK_IMPORTED_MODULE_9__.placeCaretAtHorizontalEdge)(ref.current, true);
      }
    }
  }, [url]);
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.useBlockProps)({
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('wp-block-navigation-item', {
      ...
      [(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.getColorClassName)('color', textColor)]: !!textColor,
      'has-background': !!backgroundColor || customBackgroundColor,
      [(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.getColorClassName)('background-color', backgroundColor)]: !!backgroundColor,
  ...
  const allowedBlocks = isAtMaxNesting ? ALLOWED_BLOCKS.filter(blockName => blockName !== 'ucla-wcl-wpblocks/ucla-primary-nav-submenu') : ALLOWED_BLOCKS;
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.useInnerBlocksProps)({
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('wp-block-navigation__submenu-container', {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.BlockControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.ToolbarGroup, null, !openSubmenusOnClick && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.ToolbarButton, {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Convert to Link'),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Description'),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('The description will be displayed in the menu if the current theme supports it.')
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Link title'),
    autoComplete: "off"
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextControl, {
    value: rel || '',
    onChange: relValue => {
    ...
    autoComplete: "off"
  }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ParentElement, {
    ...
    onMerge: mergeBlocks,
    onReplace: onReplace,
    "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Navigation link text'),
  ...
  }), !openSubmenusOnClick && isLinkOpen && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Popover, {
    placement: "bottom",
    ...
    createSuggestionButtonText: searchTerm => {
      ...
      if (type === 'post') {
        ...
        format = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Create draft post: <mark>%s</mark>');
      } else {
        /* translators: %s: search term. */
        format = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Create draft page: <mark>%s</mark>');
      }
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createInterpolateElement)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.sprintf)(format, searchTerm), {
    ...
    onRemove: () => {
      ...
      (0,_wordpress_a11y__WEBPACK_IMPORTED_MODULE_11__.speak)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Link removed.'), 'assertive');
    }
...
/***/ "./src/block-library/ucla-primary-nav-submenu/icons.js":
/*!*************************************************************!*\
  !*** ./src/block-library/ucla-primary-nav-submenu/icons.js ***!
  \*************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/block-library/ucla-primary-nav-submenu/save.js":
/*!************************************************************!*\
  !*** ./src/block-library/ucla-primary-nav-submenu/save.js ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/block-library/ucla-primary-nav-submenu/transforms.js":
/*!******************************************************************!*\
  !*** ./src/block-library/ucla-primary-nav-submenu/transforms.js ***!
  \******************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const transforms = {
  to: [{
    type: 'block',
    blocks: ['ucla-wcl-wpblocks/ucla-primary-nav-link'],
    ...
    transform: attributes => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('ucla-wcl-wpblocks/ucla-primary-nav-link', attributes)
  }, {
    type: 'block',
    blocks: ['core/spacer'],
    isMatch: (attributes, block) => {
...
/***/ "./src/block-library/ucla-primary-nav-submenu/block.json":
/*!***************************************************************!*\
  !*** ./src/block-library/ucla-primary-nav-submenu/block.json ***!
  \***************************************************************/
/***/ (function(module) {
...
"use strict";
/*!*************************************************************!*\
  !*** ./src/block-library/ucla-primary-nav-submenu/index.js ***!
  \*************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/block-library/ucla-primary-nav-submenu/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/block-library/ucla-primary-nav-submenu/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/block-library/ucla-primary-nav-submenu/save.js");
/* harmony import */ var _transforms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./transforms */ "./src/block-library/ucla-primary-nav-submenu/transforms.js");
/**
 * WordPress dependencies
 */
