...
/***/ "./src/block-library/ucla-primary-nav-link/edit.js":
/*!*********************************************************!*\
  !*** ./src/block-library/ucla-primary-nav-link/edit.js ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": function() { return /* binding */ NavigationLinkEdit; },
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/add-submenu.js");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./block.json */ "./src/block-library/ucla-primary-nav-link/block.json");
...
const updateNavigationLinkBlockAttributes = function () {
  ...
  const label = useNewLabel ? escape_html__WEBPACK_IMPORTED_MODULE_2___default()(newLabel) : originalLabel || escape_html__WEBPACK_IMPORTED_MODULE_2___default()(newUrlWithoutHttp);
  ...
  setAttributes({
    ...
    ...(newUrl && {
      url: encodeURI((0,_wordpress_url__WEBPACK_IMPORTED_MODULE_10__.safeDecodeURI)(newUrl))
    }),
    ...(label && {
      label
    }),
...
function getMissingText(type) {
  ...
  switch (type) {
    case 'post':
      ...
      missingText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Select post');
      break;
    case 'page':
      /* translators: label for missing page in navigation link block */
      missingText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Select page');
      break;
    case 'category':
      /* translators: label for missing category in navigation link block */
      missingText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Select category');
      break;
    case 'tag':
      /* translators: label for missing tag in navigation link block */
      missingText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Select tag');
      break;
    default:
      /* translators: label for missing values in navigation link block */
      missingText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Add link');
  }
  return missingText;
}
...
function LinkControlTransforms(_ref) {
  ...
  const {
    ...
    } = select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__.store);
    return {
      getBlock: _getBlock,
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Transform')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.Button, {
      key: `transform-${index}`,
      onClick: () => replace(clientId, (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__.switchToBlockType)(getBlock(clientId), item.name)),
      className: "link-control-transform__item"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__.BlockIcon, {
      icon: item.icon
    }), item.title);
  })));
}
function NavigationLinkEdit(_ref2) {
  ...
  const {
    saveEntityRecord
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useDispatch)(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_12__.store);
  const {
    replaceBlock,
    __unstableMarkNextChangeAsNotPersistent
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useDispatch)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__.store);
  ...
  const itemLabelPlaceholder = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Add label…');
  const ref = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  const pagesPermissions = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_12__.useResourcePermissions)('pages');
  const postsPermissions = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_12__.useResourcePermissions)('posts');
  const {
    innerBlocks,
    isAtMaxNesting,
    isTopLevelLink,
    ...
    return {
      ...
      isAtMaxNesting: getBlockParentsByBlockName(clientId, [_block_json__WEBPACK_IMPORTED_MODULE_15__.name, 'ucla-wcl-wpblocks/ucla-primary-nav-submenu']).length >= maxNestingLevel,
      isTopLevelLink: getBlockName(getBlockRootClientId(clientId)) === 'ucla-wcl-wpblocks/ucla-primary-nav',
  ...
  function transformToSubmenu() {
    const newSubmenu = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__.createBlock)('ucla-wcl-wpblocks/ucla-primary-nav-submenu', attributes, innerBlocks);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (isLinkOpen && url) {
      ...
      if ((0,_wordpress_url__WEBPACK_IMPORTED_MODULE_10__.isURL)((0,_wordpress_url__WEBPACK_IMPORTED_MODULE_10__.prependHTTP)(label)) && /^.+\.[a-z]+/.test(label)) {
        // Focus and select the label text.
        selectLabelText();
      } else {
        // Focus it (but do not select).
        (0,_wordpress_dom__WEBPACK_IMPORTED_MODULE_11__.placeCaretAtHorizontalEdge)(ref.current, true);
      }
    }
  }, [url]);
  ...
  async function handleCreate(pageTitle) {
    ...
    return {
      ...
      title: (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_13__.decodeEntities)(page.title.rendered),
      url: page.link,
      kind: 'post-type'
    };
  }
  ...
  function onKeyDown(event) {
    if (_wordpress_keycodes__WEBPACK_IMPORTED_MODULE_7__.isKeyboardEvent.primary(event, 'k') || !url && event.keyCode === _wordpress_keycodes__WEBPACK_IMPORTED_MODULE_7__.ENTER) {
      setIsLinkOpen(true);
    }
  }
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__.useBlockProps)({
    ref: (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_14__.useMergeRefs)([setPopoverAnchor, listItemRef]),
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('wp-block-navigation-item', {
      ...
      [(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__.getColorClassName)('color', textColor)]: !!textColor,
      'has-background': !!backgroundColor || customBackgroundColor,
      [(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__.getColorClassName)('background-color', backgroundColor)]: !!backgroundColor
    }),
    style: {
  ...
  const placeholderText = `(${isInvalid ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Invalid') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Draft')})`;
  const tooltipText = isInvalid || isDraft ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('This item has been deleted, or is a draft') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('This item is missing a link');
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__.BlockControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ToolbarGroup, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ToolbarButton, {
    name: "link",
    icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_16__["default"],
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Link'),
    shortcut: _wordpress_keycodes__WEBPACK_IMPORTED_MODULE_7__.displayShortcut.primary('k'),
    onClick: () => setIsLinkOpen(true)
  }), !isAtMaxNesting && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ToolbarButton, {
    name: "submenu",
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Description'),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('The description will be displayed in the menu if the current theme supports it.')
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Link title'),
    autoComplete: "off"
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.TextControl, {
    value: rel || '',
    onChange: relValue => {
    ...
    position: "top center",
    text: tooltipText
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, missingText), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "wp-block-navigation-link__missing_text-tooltip"
  }, tooltipText)))) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, !isInvalid && !isDraft && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__.RichText, {
    ref: ref,
    identifier: "label",
    ...
    onMerge: mergeBlocks,
    onReplace: onReplace,
    __unstableOnSplitAtEnd: () => insertBlocksAfter((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__.createBlock)('ucla-wcl-wpblocks/ucla-primary-nav-link')),
    "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Navigation link text'),
  ...
  }, description)), (isInvalid || isDraft) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  `${(0,lodash__WEBPACK_IMPORTED_MODULE_3__.unescape)(label)} ${placeholderText}`.trim()), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "wp-block-navigation-link__missing_text-tooltip"
  }, tooltipText))))), isLinkOpen && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.Popover, {
    placement: "bottom",
    ...
    createSuggestionButtonText: searchTerm => {
      ...
      if (type === 'post') {
        ...
        format = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Create draft post: <mark>%s</mark>');
      } else {
        /* translators: %s: search term. */
        format = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('Create draft page: <mark>%s</mark>');
      }
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createInterpolateElement)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.sprintf)(format, searchTerm), {
    ...
    onRemove: removeLink,
    renderControlBottom: !url ? () => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(LinkControlTransforms, {
      clientId: clientId,
...
/***/ "./src/block-library/ucla-primary-nav-link/hooks.js":
/*!**********************************************************!*\
  !*** ./src/block-library/ucla-primary-nav-link/hooks.js ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "enhanceNavigationLinkVariations": function() { return /* binding */ enhanceNavigationLinkVariations; }
/* harmony export */ });
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/post-content.js");
...
function enhanceNavigationLinkVariations(settings, name) {
  if (name !== 'ucla-wcl-wpblocks/ucla-primary-nav-link') {
    return settings;
  }
...
/***/ "./src/block-library/ucla-primary-nav-link/save.js":
/*!*********************************************************!*\
  !*** ./src/block-library/ucla-primary-nav-link/save.js ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/block-library/ucla-primary-nav-link/transforms.js":
/*!***************************************************************!*\
  !*** ./src/block-library/ucla-primary-nav-link/transforms.js ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const transforms = {
  from: [{
    ...
    transform: () => {
      return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('ucla-wcl-wpblocks/ucla-primary-nav-link');
    }
  }, {
    type: 'block',
    blocks: ['core/spacer'],
  ...
  to: [{
    ...
    transform: (attributes, innerBlocks) => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('ucla-wcl-wpblocks/ucla-primary-nav-submenu', attributes, innerBlocks)
  }, {
    type: 'block',
    blocks: ['core/spacer'],
    transform: () => {
...
/***/ "./src/block-library/ucla-primary-nav-link/block.json":
/*!************************************************************!*\
  !*** ./src/block-library/ucla-primary-nav-link/block.json ***!
  \************************************************************/
/***/ (function(module) {
...
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./hooks */ "./src/block-library/ucla-primary-nav-link/hooks.js");
